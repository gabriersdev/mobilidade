                                      ...
                                      <div className={"d-flex align-items-center flex-wrap gap-1"}>
                                        {
                                          moment(d?.["expected_arrival_time"]).diff(moment(), "minutes") > 0 ? (
                                            <>{(d?.["order_departure_point"] ?? -1) === 1 ? "Saindo" : (parseInt(d?.["order_departure_point"] ?? "-1", 10) === parseInt(d?.["total_departure_points"] ?? "-2", 10)) ? "Somente desembarque - Chegará" : "Chegará"} {Util.diffToHuman(moment(d?.["expected_arrival_time"]))}</>
                                          ) : (
                                            <>
