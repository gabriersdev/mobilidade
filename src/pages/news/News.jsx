      ...
      <div className="mt-lg-5 d-flex flex-column gap-5">
        {
          [
            {
              title: "Linha 4992 Sabará <-> Terminal São Gabriel deixa de operar nesta segunda (02/05)",
            ...
            <div className={"border-bottom border-secondary-subtle pb-5"} key={index}>
              <NewsC id={item.id} title={item.title} resume={item.resume} content={item.content} img={item.img}/>
            </div>
          ))
        }
      </div>
