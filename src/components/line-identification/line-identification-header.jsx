    ...
    <div className={"d-flex align-items-start flex-wrap gap-3 justify-content-between flex-column flex-column-reverse flex-lg-row"}>
      <div>
        <hgroup className="d-flex align-items-center gap-2 flex-wrap mb-0">
          ...
          <Title type="h2" classX=" fs-3 d-inline text-body-emphasis fw-semibold m-0 p-0">Linha {line.line_number}</Title>
          <span className="text-body-secondary">|</span>
          <Title type="h2" classX=" fs-3 d-inline text-body-secondary fw-semibold m-0 p-0 lh-sm">{line.departure_location} ⇄ {line.destination_location}</Title>
        </hgroup>
