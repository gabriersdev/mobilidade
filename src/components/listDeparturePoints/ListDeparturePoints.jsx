          ...
          <Offcanvas.Body className={"d-flex flex-column gap-3"}>
            ...
            <section>
              <iframe
                ...
                src={`https://www.google.com/maps/embed/v1/place?key=AIzaSyDLVLgUmpHx7VfSA0qTMhYdKW1SVXKFTak&q=${Util.convertToSafeText(pointDataOffcanvas.address ? pointDataOffcanvas.address.toLowerCase() : '')}-sabara-minas-gerais`}>
              </iframe>
              ...
              <a className={"link-opacity-100 d-flex gap-1 align-items-center mt-1"} style={{textDecoration: 'none'}}
                 href={`https://www.google.com/maps/search/?api=1&query=${Util.convertToSafeText(pointDataOffcanvas.address).replaceAll('-', '%20')}%20Sabara%20Minas%20Gerais`}
