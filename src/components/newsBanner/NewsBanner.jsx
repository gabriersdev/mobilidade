...
function NewsBanner() {
  return (
    <Link to={"/news"} className={"pt-4 px-4 pb-4 bg-primary-subtle rounded-3 border border-primary-subtle d-flex flex-column gap-3 text-decoration-none"}>
      <div className={"d-flex flex-column gap-4 align-items-start"}>
        <Badge className={"badge bg-primary text-white fw-normal fs-6 rounded-pill"}>Leia</Badge>
