        ...
        !codeIsSent ? (
          <>
            <FormGroup>
              ...
              <FormControl type={"email"} id={"mail"} className={"mb-0"} required={true} value={email} onChange={(e) => setEmail(e.target.value)} {...propsInput.current} maxLength={100} ref={refMail}/>
            </FormGroup>
          </>
        ) :
          !allOK ? (
