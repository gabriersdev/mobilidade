const STATIC_CACHE_NAME = 'mobilidade-app-v8'; // Versão do cache (IMPORTANTE: altere a versão a cada atualização)
const DYNAMIC_CACHE_NAME = 'dynamic-mobilidade-app-v8';
